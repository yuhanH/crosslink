...
def main():
    ...
    # Load data and model
    train_loader = DataLoader(TFBindingDataset(mode = 'train'), batch_size = 128, shuffle = True, num_workers = 30)
    val_loader = DataLoader(TFBindingDataset(mode = 'val'), batch_size = 128, shuffle = True, num_workers = 10)
